...
import tk.sonaapi.sona_bacode.utils.AudioWriterPCM;


public class NaverActivity extends Activity {

    private static final String CLIENT_ID = "LQjZFSCJUSPnsmlM_Oh8"; // "내 애플리케이션"에서 Client ID를 확인해서 이곳에 적어주세요.
    ...
    private void handleMessage(Message msg) {
        switch (msg.what) {
            case R.id.clientReady:
                ...
                writer = new  tk.sonaapi.sona_bacode.utils.AudioWriterPCM(
